...
export const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Products POS', href: '/reception/products-pos', icon: LuPackage, moduleKey: 'POS' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Invoices', href: '/finance/invoices', icon: LuFileText },
      { label: 'Quotations', href: '/finance/quotations', icon: LuSignature },
